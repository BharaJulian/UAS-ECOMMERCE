			...
			<nav class="navbar navbar-default mu-navbar">
			  	<div class="container-fluid">
				    ...
				    <div class="navbar-header">
				      ...
				      <!-- Text Logo -->
				      <a class="navbar-brand" href="index.html"><i class="fa fa-book" aria-hidden="true"></i>Bo'Books</a>
				    ...
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      	<ul class="nav navbar-nav mu-menu navbar-right">
					        <li><a href="{{ URL::to('kategori') }}">HOME</a></li>
					        <li><a href="#mu-book-overview">PRODUCT</a></li>
					        <li><a href="#mu-author">CATEGORY</a></li>
				            <li><a href="#mu-pricing">CONTACT</a></li>
	...
	<section id="mu-hero">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 col-sm-push-9">
					<div class="mu-hero-right">
						<img src="{{asset('fn/images/buku2.jpeg')}}" alt="buku2.jpeg">
					</div>
				</div>
				...
				<div class="col-md-6 col-sm-6 col-sm-pull-6">
					<div class="mu-hero-left">
						...
						<a href="#" class="mu-primary-btn"><b>Order Now !!</b></a>
						<span>........</span>
					</div>
				</div>	
